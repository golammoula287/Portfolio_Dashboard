    ...
    <>
      <div className='w-full h-full bg1 p-10 text-white rounded-md'>
            ...
            <div className='grid gap-4 mt-4 '>
                <div className='flex items-start lg:justify-between lg:items-center flex-col lg:flex-row gap-5  bg3 p-4 rounded-md'>
                  ...
                  <div className='grid gap-2 bg3 p-4 rounded-md'>
